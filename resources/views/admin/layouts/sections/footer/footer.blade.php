...
<footer class="content-footer footer bg-footer-theme">
  <div class="{{ $containerFooter }}">
    <div class="footer-container d-flex align-items-center justify-content-between py-4 flex-md-row flex-column">
      <div class="text-body">
        © <script>document.write(new Date().getFullYear())</script>, made with by <a href="{{ (!empty(config('variables.creatorUrl')) ? config('variables.creatorUrl') : 'https://github.com/Khainguyen0207/') }}" target="_blank" class="footer-link">{{ (!empty(config('variables.creatorName')) ? config('variables.creatorName') : 'FogDeveloper') }}</a>
      </div>
      <div class="d-none d-lg-inline-block">
        <a href="https://github.com/Khainguyen0207/" target="_blank" class="footer-link me-4">
