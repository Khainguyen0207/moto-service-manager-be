    ...
    <div class="card overflow-hidden">
        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-dark">
                ...
                <tr>
                    <td class="rounded-start-bottom"><i class="bx bxl-bootstrap bx-md text-primary me-3"></i> <span>Bootstrap Project</span>
                    </td>
                    <td>Jerry Milton</td>
                    <td>
                        <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
    ...
    <div class="card">
        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tr class="table-dark">
                    <td class="rounded-start-bottom"><i class="bx bxl-bootstrap bx-md text-primary me-4"></i> <span>Bootstrap UI</span>
                    </td>
                    <td>Jerry Milton</td>
                    <td>
                        <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
