...
(function( factory ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"sSearch": "<i class=\"icon-base bx bx-search\"></i>",
	...
	DataTable.feature.register( 'search', function ( settings, opts ) {
		...
		var input = '<input type="search" placeholder=""  class="'+classes.input+'"/>';
		...
		var str = '<span>' + opts.text + '</span>';

		if (start) {
			str = '_INPUT_<span>' + removed + '</span>';
		}
		else if (end) {
			str = '<span class="input-group-text">' + removed + '</span>_INPUT_';
		}
		...
		filter.find('span').attr('for', 'dt-search-' + __searchCounter);
